...
<body>
    ...
    <div class="main" id="main">
        <div class="purplebar"><a href= "account"><img src="{{ asset('image/return.png')}}" width="30px" height="30px"></a></div>
        ...
        @csrf
            ...
            <div>
                ...
                <div class="password">
                    <img src="{{ asset('image/password.png')}}" width="35px" height="35px" style="visibility:hidden">
            ...
            <div>
                ...
                <div class="roles">
                    <img src="{{ asset('image/roles.png')}}" width="35px" height="35px" >
                    <select name="roles">
