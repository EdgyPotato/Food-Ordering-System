    ...
    <div class="flex flex-row">
        ...
        <div class="flex flex-col w-full h-full">
            <header class="flex fixed justify-center items-center w-[80%] h-[120px]">
                ...
                ?>
                <div class="flex flex-row justify-center items-center px-[5px] gap-[5px] rounded-lg bg-grey-500 w-[452px] h-[70px]">
                    ...
                    <a href="complete"><button type="button" class="flex flex-col justify-center items-center text-lg font-bold text-white bg-grey-700 rounded-lg w-36 h-[60px]">Completed<div class="-mt-2 text-2xl" id="completed"><?php echo $completed; ?></div></button></a>
                </div>
            </header>
