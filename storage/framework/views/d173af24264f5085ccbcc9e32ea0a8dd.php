                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="font-medium text-black opacity-80 text-center"><?php echo $paymentfoodnos->quantity ?></td>
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5">
                            <form class="space-y-4" action="/send-mail">
...
</html><?php /**PATH C:\AD Project\AD-Project\resources\views/invoicedetails.blade.php ENDPATH**/ ?>