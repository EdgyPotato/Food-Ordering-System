    ...
    <div class="flex flex-row">
        ...
        <main class="flex flex-col w-full h-full">
            ...
            <div class="flex items-center justify-end flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 px-12 py-4 dark:bg-gray-900">
                <form action="reservationhistory" method="get" class="flex items-center">
                    ...
                    <tbody>
                        <?php foreach ($reservation as $reservations) { ?>
                            <tr class="bg-pigment-indigo-100 border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <?php echo $reservations->updated_at ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
...
</html><?php /**PATH C:\AD Project\AD-Project\resources\views/reservationhistory.blade.php ENDPATH**/ ?>