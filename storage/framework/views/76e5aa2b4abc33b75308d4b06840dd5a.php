...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/addmenu.css')); ?>">
    <!-- Load icon library -->
...
<body>
    ...
    <div class="main" id="main">
        <form action="menu" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="purplebar"><a href= "adminmenu"><img src="<?php echo e(asset('image/return.png')); ?>" width="30px" height="30px"></a></div>
            ...
            <div class="text_input">
                <div class="main_point">
                    <div class="firstrow">
                        <div class="id">ID<br><input type="text" name="id" placeholder="Fxx"></div>
                        <div class="foodname">Food name<br><input type="text" name="foodname" placeholder="Chicken"></div>
                        
                    </div>
                    <br>
                    <div class="secondrow">
                        <div class="price">Price<br><input type="text" name="foodprice" placeholder="xx.xx"></div>
                    ...
                    <br>Description<br><input class="description" type="text" name="description">
                </div>
                <div class="add_point">
                    <div id="addcontent">
    ...
    <script>
        ...
        var imgSrc2 = "<?php echo e(asset('image/dustbin.png')); ?>";
