                        ...
                        <tbody>
                            <?php foreach ($sql as $food) { ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="p-4">
                                        <img src="data:image/jpeg;base64,<?php echo e($food->image_url); ?>" class="w-20 h-20 rounded-md shadow-lg" alt="Food Image">
                                    </td>
...
</html><?php /**PATH D:\ADProject\AD-Project\resources\views/adminmenu.blade.php ENDPATH**/ ?>