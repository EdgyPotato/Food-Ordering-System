...
<body class="bg-gray-200 ">
    ...
    <form method='GET' action='cusedit'>
        <div class="flex flex-col items-center">
            <div class="w-11/12 mt-8 bg-white shadow-md max-w-md rounded-xl">
                <img class="rounded-xl w-full" src="data:image/jpeg;base64,<?php echo e($food->image_url); ?>">
            </div>
        ...
        <div class="w-full px-8 py-3 fixed inset-x-0 bottom-0 shadow-inner bg-pigment-indigo-100">
            <div class="flex flex-row justify-between">
                <div class="flex flex-row justify-center items-center text-center">
                    ...
                    <input type="hidden" id="selectednumber" name="selectedno" value="<?php echo $_GET['action']?>">
                ...
                <input type="submit" value="Confirm" class="inline-block px-4 py-2 text-center text-xl font-bold bg-pigment-indigo-400 border-4 border-pigment-indigo-500 text-white rounded-lg shadow-md">
            </div>
        </div>
    </form>
</body>

</html><?php /**PATH C:\AD Project\AD-Project\resources\views/foodedit.blade.php ENDPATH**/ ?>