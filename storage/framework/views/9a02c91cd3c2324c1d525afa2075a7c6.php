    ...
    <div class="flex flex-row">
        ...
        <main class="flex flex-col w-full h-full">
            ...
            <div class="m-16 mb-0 p-8 border-solid rounded-2xl shadow-lg bg-white min-w-screen min-h-full transition-all">
                ...
                <div class="block w-full h-64 py-2 px-3 bg-aqua-green-100 opacity-80 border-solid border-2 border-black rounded-md"><?php echo $notification->description; ?></div>
                <?php if($notification->roles == "Staff" && $notification->status == "In Progress"){?>
...
</html><?php /**PATH C:\AD Project\AD-Project\resources\views/notifydetails.blade.php ENDPATH**/ ?>