...
<body class="bg-grey-200">
    <div class="flex flex-row">
        ...
        <main class="w-full h-full">
            <div class="w-full px-6 py-4 shadow-md bg-gradient-to-b from-aqua-green-500 to-aqua-green-400">
                <div class="flex justify-end">
                    <a class="flex justify-end" href="chefaddnotification"><img src="<?php echo e(asset('image/plus.png')); ?>" width="30px" height="30px"></a>
                </div>
            </div>
