    ...
    <div class="flex flex-row">
        ...
        <main class="flex flex-col w-full h-full">
            ...
            <div class="flex items-center justify-end flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 px-12 py-4 dark:bg-gray-900">
                <form id="dateform" action="invoicehistory" method="get" class="flex items-center">
            ...
            <form id='form' method="get" action="invoicedetails" class="px-12 pb-8">
                        ...
                        <tbody>
                            ...
                            if (count($sql))
                                foreach ($sql as $invoice) {
                                    $tableNo = DB::table('payment_food_nos')->where('payment_id', $invoice->id)->first();
                            ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" onclick="submitForm('<?php echo $invoice->id ?>')">
                                    <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                                        <?php echo "INV100" . $invoice->id; ?>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php echo $tableNo->table_no; ?>
                                    </td>
                                    <td class="px-6 py-4">
...
</html><?php /**PATH C:\AD Project\AD-Project\resources\views/invoicehistory.blade.php ENDPATH**/ ?>