    ...
    <div class="flex flex-row">
        <div class="flex flex-row justify-start w-[25%]">
            ...
            <div class="flex flex-col w-[18%] ml-[2%] h-full fixed bg-white">
                ...
                <a class="flex flex-row w-full h-1/4 px-[15%] items-center font-bold text-xl" href="reservation_staff"><img class="mr-1" src="<?php echo e(asset('image/reservation.png')); ?>" width="35px" height="35px">Reservation</a>
                    ...
                    <a class="flex flex-row w-full h-1/4 px-[15%] items-center font-bold text-xl" href="orderlist"><img src="<?php echo e(asset('image/order.png')); ?>" width="35px" height="35px">Order List</a>
                    <a class="flex flex-row w-full h-1/4 px-[15%] items-center font-bold text-xl bg-grey-200" href="notification"><img src="<?php echo e(asset('image/notification.png')); ?>" width="35px" height="35px">Notification</a>
        ...
        <main class="flex flex-col w-full h-full">
            <div class="w-full px-6 py-4 shadow-md bg-gradient-to-r from-pigment-indigo-500 to-pigment-indigo-400">
                <div class="flex justify-start">
                    <a class="flex justify-end" href="notification"><img src="<?php echo e(asset('image/return.png')); ?>" width="30px" height="30px"></a>
                </div>
            </div>
                ...
                <form class="w-full p-8" action="addnotification" method="get">
                    ...
                    <div class="flex">
                        <span class="inline-flex items-center px-3 text-m text-gray-900 bg-gray-200 border border-e-0 border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                            <img src="<?php echo e(asset('image/subject.png')); ?>" width="25px" height="25px">
                        </span>
...
</html><?php /**PATH C:\AD Project\AD-Project\resources\views/staffaddnotification.blade.php ENDPATH**/ ?>